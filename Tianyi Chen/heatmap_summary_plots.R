...
library(readr)
final_errors <- read_csv("/Users/tianyichen/Desktop/Research /PhDresearch/London model with GM/Github/Simulation/Mohammad Sharifi/final_errors_London.cvs")
...
final_sd=final_errors[,seq(2,23,by=2)]
